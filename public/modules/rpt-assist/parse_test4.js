...
2	19 JAN - 23 JAN	Tema 1: MEKANIK NEWTON	1.0 Daya dan Gerakan II	1.1 Daya Paduan	1.1.3 (i) Berkomunikasi tentang daya paduan, F apabila objek berada dalam keadaan: (i) pegun, F = 0 N	17 Jan Isra' Mikraj
2	19 JAN - 23 JAN	Tema 1: MEKANIK NEWTON	1.0 Daya dan Gerakan II	1.1 Daya Paduan	1.1.3 (ii) Berkomunikasi tentang daya paduan, F apabila objek berada dalam keadaan: (ii) bergerak dengan halaju seragam, F = 0 N	17 Jan Isra' Mikraj
2	19 JAN - 23 JAN	Tema 1: MEKANIK NEWTON	1.0 Daya dan Gerakan II	1.1 Daya Paduan	1.1.3 (iii) Berkomunikasi tentang daya paduan, F apabila objek berada dalam keadaan: (iii) bergerak dengan pecutan seragam, F ≠ 0 N	17 Jan Isra' Mikraj
2	19 JAN - 23 JAN	Tema 1: MEKANIK NEWTON	1.0 Daya dan Gerakan II	1.1 Daya Paduan	1.1.4 Menyelesaikan masalah yang melibatkan daya paduan, jisim dan pecutan suatu objek.	17 Jan Isra' Mikraj`;
...
function parseData(str) {
    ...
    for (let line of lines) {
        ...
        if (cols.length >= 3) rows.push(cols.map(c => c.trim()));
    }
